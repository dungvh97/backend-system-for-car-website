...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
         ...
         */
    	MvcResult result = mvc.perform(get(new URI("/cars"))).andReturn();
    	String json = result.getResponse().getContentAsString();
    	
    	// cannot convert to Resources<Resource<Car>> 
//    	Car[] cars = new ObjectMapper().readValue(json, Car[].class);
    	
    	assertTrue(json.contains("\"id\":1"));
    	assertTrue(json.contains("\"body\":\"sedan\""));
    }
    ...
    public void findCar() throws Exception {
    	...
    	// can not create it by mock
//    			.andExpect(jsonPath("location.city", notNullValue()))
